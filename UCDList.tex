...
Q & \ucd{meta.coverage}& A coverage (spatial, temporal, spectral, etc)\\
...
Q & \ucd{obs.atmos.humidity}& Amount of air humidity at observing site during an observation\\
Q & \ucd{obs.atmos.rain}& Amount of rain at the telescope site during an observation\\
Q & \ucd{obs.atmos.refractAngle}& Atmospheric refraction angle\\
S & \ucd{obs.atmos.turbulence}& Related to atmospheric turbulence at the telescope site\\
P & \ucd{obs.atmos.turbulence.isoplanatic}& Isoplanatic angle characterising the atmospheric turbulence at telescope site\\
Q & \ucd{obs.atmos.water}& Amount of atmospheric water at observing site\\
S & \ucd{obs.atmos.wind}& Related to atmospheric wind at observing site\\
...
Q & \ucd{phys.inspiralSpin}& Effective inspiral spin in binary mergers (used in GW detections)\\
...
Q & \ucd{phys.temperature.dew}& Dew temperature measured at the telescope site during an observation\\
...
Q & \ucd{phys.voltage}& Electric potential difference over a distance or measured by an instrument\\
...
Q & \ucd{pos.projection}& 2D spatial projection\\
...
P & \ucd{stat.confidenceLevel}& Level of confidence for a detection or classification process\\
...
Q & \ucd{stat.stdev}& Standard deviation as the square root of the variance\\
...
Q & \ucd{time.period.pulsation}& Period of pulsation or oscillation of a body or a phenomenon\\
